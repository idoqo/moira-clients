...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>, IValidatableObject
    {
        ...
        public InlineResponse2005(string login = default(string), List<Contact> contacts = default(List<Contact>), List<Subscription> subscriptions = default(List<Subscription>))
        {
            this.Login = login;
