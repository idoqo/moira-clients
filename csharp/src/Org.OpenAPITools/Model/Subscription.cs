...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Subscription :  IEquatable<Subscription>, IValidatableObject
    {
        ...
        public Subscription(List<string> contacts = default(List<string>), List<string> tags = default(List<string>), SubscriptionSched sched = default(SubscriptionSched), SubscriptionPlotting plotting = default(SubscriptionPlotting), string id = default(string), bool enabled = default(bool), bool anyTags = default(bool), bool ignoreWarnings = default(bool), bool ignoreRecoverings = default(bool), bool throttling = default(bool), string user = default(string))
        {
