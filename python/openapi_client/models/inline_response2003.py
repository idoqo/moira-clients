...
class InlineResponse2003(object):
    ...
    """
    openapi_types = {
        'list': 'list[InlineResponse2003List]'
    }
    ...
    @property
    def list(self):
        """Gets the list of this InlineResponse2003.  # noqa: E501

        List of fetched patterns  # noqa: E501

        :return: The list of this InlineResponse2003.  # noqa: E501
        :rtype: list[InlineResponse2003List]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this InlineResponse2003.

        List of fetched patterns  # noqa: E501

        :param list: The list of this InlineResponse2003.  # noqa: E501
        :type: list[InlineResponse2003List]
        """
