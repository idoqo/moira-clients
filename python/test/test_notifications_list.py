...
from openapi_client.models.notifications_list import NotificationsList  # noqa: E501
...
class TestNotificationsList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.notifications_list.NotificationsList()  # noqa: E501
        if include_optional :
            return NotificationsList(
                total = 56, 
                list = [
                    openapi_client.models.notifications_list_list.NotificationsList_list(
